...
Route::middleware("auth")->prefix("/admin")->group(function () {
    ...
    Route::prefix('users')->group(function () {
        ...
        Route::put("update/{id}", [UserController::class, 'updateUser'])->name("admin.users.update")->middleware('checkPermission:editUser');
    ...
    Route::prefix("post-catelogue")->group(function () {
        ...
        Route::post("post-catelogueStore", [PostCatelogueController::class, "store"])->name("admin.post-catelogue.store")->middleware('checkPermission:createPostCatelogue');
        ...
        Route::put("{id}/update", [PostCatelogueController::class, "PostCatelogueUpdate"])->name("admin.post-catelogue.update")->middleware('checkPermission:editPostCatelogue');
    ...
    Route::prefix("post")->group(function () {
        ...
        Route::post("postStore", [PostController::class, "store"])->name("admin.post.store")->middleware('checkPermission:createPost');
        Route::get("{id}/edit", [PostController::class, "editPost"])->name("admin.post.edit")->middleware('checkPermission:editPost');
        Route::put("{id}/update", [PostController::class, "update"])->name("admin.post.update")->middleware('checkPermission:editPost');
    ...
    Route::prefix("product")->group(function () {
        ...
        Route::post("postStore", [ProductController::class, "store"])->name("admin.product.store")->middleware('checkPermission:createProduct');
        Route::get("{id}/edit", [ProductController::class, "editPost"])->name("admin.product.edit")->middleware('checkPermission:editProduct');
        Route::put("{id}/update", [ProductController::class, "update"])->name("admin.product.update")->middleware('checkPermission:editProduct');
    ...
    Route::prefix("product-catelogue")->group(function () {
        ...
        Route::post("postStore", [ProductCatelogueController::class, "store"])->name("admin.product_catelogue.store")->middleware('checkPermission:createProductCatelogue');
        ...
        Route::put("{id}/update", [ProductCatelogueController::class, "update"])->name("admin.product_catelogue.update")->middleware('checkPermission:editProductCatelogue');
    ...
    Route::prefix("variant-catelogue")->group(function () {
        ...
        Route::post("postStore", [AttributeController::class, "store"])->name("admin.variant_catelogue.store")->middleware('checkPermission:createVariantCatelogue');
        ...
        Route::put("{id}/update", [AttributeController::class, "update"])->name("admin.variant_catelogue.update")->middleware('checkPermission:editVariantCatelogue');
    ...
    Route::prefix("variant")->group(function () {
        ...
        Route::post("postStore", [AttributeValueController::class, "store"])->name("admin.variant.store")->middleware('checkPermission:createAttributeValue');
        ...
        Route::put("{id}/update", [AttributeValueController::class, "update"])->name("admin.variant.update")->middleware('checkPermission:editAttributeValue');
    ...
    Route::prefix('promotions')->group(function () {
        ...
        Route::post('/store', [PromotionController::class, 'store'])->name('admin.promotions.store')->middleware('checkPermission:createPromotion');
        Route::get('/{id}/edit', [PromotionController::class, 'edit'])->name('admin.promotions.edit')->middleware('checkPermission:editPromotion');
        Route::put('/{id}/update', [PromotionController::class, 'update'])->name('admin.promotions.update')->middleware('checkPermission:editPromotion');
    ...
    Route::prefix("about")->group(function () {
        ...
        Route::post('/store', [AboutPageController::class, 'store'])->name('admin.about.store')->middleware('checkPermission:createAboutPage');
        Route::get("{id}/edit", [AboutPageController::class, "edit"])->name("admin.about.edit")->middleware('checkPermission:editAboutPage');
        Route::put("{id}/update", [AboutPageController::class, "update"])->name("admin.about.update")->middleware('checkPermission:editAboutPage');
    ...
    Route::prefix("product-comment")->group(function(){
        ...
        Route::post('/product-review/{id}/comment', [ProductCommentController::class, 'store'])->name('product_comment.store')->middleware('checkPermission:createComment');
    ...
    Route::prefix("brand")->group(function () {
        ...
        Route::post("postStore", [BrandController::class, "store"])->name("admin.brand.store")->middleware('checkPermission:createBrand');
        Route::get("{id}/edit", [BrandController::class, "edit"])->name("admin.brand.edit")->middleware('checkPermission:editBrand');
        Route::put("{id}/update", [BrandController::class, "update"])->name("admin.brand.update")->middleware('checkPermission:editBrand');
    ...
    Route::prefix("contact")->group(function () {
        ...
        Route::put("{id}/update", [ContactController::class, "update"])->name("admin.contact.update")->middleware('checkPermission:editContact');
    ...
    Route::prefix("information")->group(function () {
        ...
        Route::post("postStore", [InformationController::class, "store"])->name("admin.information.store")->middleware('checkPermission:createInformation');
        ...
        Route::put("{id}/update", [InformationController::class, "update"])->name("admin.information.update")->middleware('checkPermission:editInformation');
    ...
    Route::prefix("shipping-fee")->group(function () {
        ...
        Route::post("postStore", [ShippingFeeController::class, "store"])->name("admin.shipping_fee.store")->middleware('checkPermission:createShippingFee');
        ...
        Route::put("{id}/update", [ShippingFeeController::class, "update"])->name("admin.shipping_fee.update")->middleware('checkPermission:editShippingFee');
    ...
    Route::prefix("customer")->group(function () {
        ...
        Route::put("{id}/update", [CustomerController::class, "update"])->name("admin.customer.update")->middleware('checkPermission:editCustomer');
    ...
    Route::prefix("group-permission")->group(function () {
        ...
        Route::put("{id}/update", [GroupPermissionController::class, "update"])->name("admin.group_permission.update")->middleware('checkPermission:editGroupPermission');
    ...
    Route::prefix("permission")->group(function () {
        ...
        Route::put("{id}/update", [PermissionController::class, "update"])->name("admin.permission.update")->middleware('checkPermission:editPermission');
    ...
    Route::prefix("banner")->group(function () {
        ...
        Route::post("postStore", [BannerController::class, "store"])->name("admin.banner.store")->middleware('checkPermission:createBanner');
        Route::get("{id}/edit", [BannerController::class, "edit"])->name("admin.banner.edit")->middleware('checkPermission:editBanner');
        Route::put("{id}/update", [BannerController::class, "update"])->name("admin.banner.update")->middleware('checkPermission:editBanner');

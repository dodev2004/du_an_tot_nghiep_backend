        ...
        <tr>
            ...
            <td>
                <form name="form_status" action="">
                    ...
                    <input type="checkbox" @if($user->status == 1) checked @endif data-id="{{$user->id}}"
                    class="js-switch js-switch_{{$user->id}}" style="display: none;" data-switchery="true">
                </form>

            </td>
            <td>
                <div class="" style="display:flex;justify-content: center;column-gap: 12px">
                    <a class="btn btn-sm btn-info" href="{{ route('admin.customer.show', $user->id) }} "
                        data-toggle="tooltip" data-placement="top" title="xem chi tiết"><i class="fa fa-paste"></i></a>

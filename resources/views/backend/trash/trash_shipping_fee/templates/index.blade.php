    ...
    <div class="row">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                @include("backend.trash.trash_shipping_fee.components.fillter")
                @include("backend.trash.trash_shipping_fee.components.table")
                @include("backend.trash.trash_shipping_fee.components.page")

<div class="ibox-content_top">
    <form action="{{ route('admin.role') }}" method="GET" class="form_seach">
    ...
    <div style="margin-bottom: 15px;">
        <a href="{{ route('admin.role') }}" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Trở về danh sách">

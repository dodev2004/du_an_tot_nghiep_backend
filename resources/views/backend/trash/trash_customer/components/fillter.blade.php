<div class="ibox-content_top">
    <form action="{{ route('admin.customer') }}" method="GET" class="form_seach">
    ...
    <div style="margin-bottom: 15px;">
        <a href="{{ route('admin.customer') }}" class="btn btn-secondary" data-toggle="tooltip" data-placement="top"

<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            {{-- <td>
            <a class="btn btn-sm btn-info" title="Chỉnh sửa" href="{{ route("admin.user_catelogue.edit",$item->id)}}" ><i class="fa fa-paste"></i> Edit</a>
            <form action="" method="POST" data-url="user_catelogue" class="form-delete">
                @method("DELETE")
                @csrf
                <input type="hidden" value="{{$item->id}}" name="id">
                <button class="btn btn-sm btn-danger" title="Xóa"><i class="fa-solid fa-trash"></i> Xóa</button>
            </form>
            ...
            <td style="text-align: center">
                <div style="display: flex; justify-content: center;column-gap: 5px;">
                    ...
                    <a class="btn btn-sm btn-info" href="{{ route("admin.user_catelogue.edit",$item->id)}}"><i
                            class="fa fa-pencil" title="Chỉnh sửa"></i></a>

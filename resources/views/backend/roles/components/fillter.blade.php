<div class="ibox-content_top">
    <form action="" method="GET" class="form_seach">
        <div class="form-group d-flex align-items-center">
            ...
            <a href="{{ route('admin.role.create') }}" class="btn btn-success"><i class="fa-solid fa-plus"></i> Thêm
                mới vai trò</a>
            </div>
        </div>
    </form>
        ...
        <div class="total_record">
            ...
            <div style="margin-top: 15px;">
                <a href="{{ route('admin.role.trash') }}" class="btn btn-danger" data-toggle="tooltip"

<div class="ibox-content_top">
    ...
    <div class="total_record">
        ...
        <div style="margin-top: 15px;">
            <a href="{{route("admin.shipping_fee.create")}}" class="btn btn-success"><i class="fa-solid fa-plus"></i>
                Thêm mới</a>
            <a href="{{ route('admin.shipping_fee.trash') }}" class="btn btn-danger" data-toggle="tooltip"

<form action="{{route("admin.shipping_fee.store")}}" method="POST" class="form-add" style="background-color: white; padding:40px" novalidate >
    @csrf
    <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-8" style="padding:20px 0 0 50px">
            <div class="row" style="display: flex; flex-wrap:wrap">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number"  name="weight_limit" class="form-control" value="{{old("weight_limit")}}" autocomplete="">
                    <p  class=" text-danger message-error"></p>
                </div>
            </div>
        </div>
